...
static struct node* _ring_node(T ring, int position);
...
void *
ring_put(T ring, int position, void *x)
{
    struct node *q;
    void *prev;
...
void *
ring_add(T ring, int position, void *x)
{
    struct node *p, *q;
    int i;
...
void *
ring_remove(T ring, int position)
{
    void *x;
    struct node *q;
...
static 
struct node* 
_ring_node(T ring, int position)
{
    struct node* pn;
    int n;
