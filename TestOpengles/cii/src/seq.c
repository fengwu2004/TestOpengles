...
static inline void *_access_get(T seq, int position);
static inline void *_access_set(T seq, int position, void *x);
...
void *
seq_put(T seq, int position, void *x)
{
    void *prev;
...
inline 
void *
_access_get(T seq, int position)
{
...
inline
void *
_access_set(T seq, int position, void *x)
{
    return ((void **)seq->array.array)[
